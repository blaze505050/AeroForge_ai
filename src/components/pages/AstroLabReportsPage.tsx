...
<head>
  <meta charset="UTF-8">
  <title>ASTROLAB Experiment Report</title>
  <style>
    ...
    .section h2 { color: #0EA5E9; border-left: 4px solid #0EA5E9; padding-left: 10px; margin-top: 0; }
    .metadata { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px; }
    .metadata-item { background: #F1F5F9; padding: 10px; border-radius: 4px; }
    .metadata-label { font-weight: bold; color: #475569; font-size: 12px; }
    .metadata-value { color: #0F172A; font-size: 14px; margin-top: 5px; }
    .parameters, .results { background: #F8FAFC; padding: 15px; border-radius: 4px; border-left: 3px solid #0EA5E9; }
    .param-row { display: grid; grid-template-columns: 200px 1fr; gap: 20px; margin-bottom: 10px; }
    .param-label { font-weight: 500; color: #475569; }
    .param-value { color: #0F172A; font-family: 'Courier New', monospace; }
...
<body>
  ...
  <div class="section">
    ...
    <div class="metadata">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">${selectedExp.tags.join(', ') || 'None'}</div>
      </div>
    </div>
  </div>
      ...
      ${Object.entries(selectedExp.parameters)
        .map(([key, value]) => {
          ...
          if (typeof value === 'number') {
            displayValue = value > 1e6 ? value.toExponential(3) : value.toFixed(4);
          }
          return `
        <div class="param-row">
  ...
  <div class="footer">
    <p>Generated by ASTROLAB on ${format(new Date(), 'MMMM d, yyyy HH:mm:ss')}</p>
    ...
    link.href = url;
    link.download = `astrolab-report-${selectedExp.id}.html`;
